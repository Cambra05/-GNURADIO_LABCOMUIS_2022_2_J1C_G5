...
class Lab_punto2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Lab_Punto2_Mu", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab_Punto2_Mu")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab_punto2")
...
def main(top_block_cls=Lab_punto2, options=None):
