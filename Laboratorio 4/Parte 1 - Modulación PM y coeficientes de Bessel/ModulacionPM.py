...
from EnvolventeComplejaPMJ1C import EnvolventeComplejaPMJ1C  # grc-generated hier_block
...
class ModulacionPM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_freq_sink.enable_autoscale(True)
        ...
        self.Signal_Source = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, fm, Am, 0, 0)
        self.EnvolventeComplejaPMJ1C_0 = EnvolventeComplejaPMJ1C(
            Ac=Ac,
            kp=kp,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.EnvolventeComplejaPMJ1C_0, 0), (self.qtgui_freq_sink, 0))
        self.connect((self.EnvolventeComplejaPMJ1C_0, 0), (self.qtgui_time_sink, 0))
        self.connect((self.EnvolventeComplejaPMJ1C_0, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.Signal_Source, 0), (self.EnvolventeComplejaPMJ1C_0, 0))
    ...
    def set_kp(self, kp):
        self.kp = kp
        self.EnvolventeComplejaPMJ1C_0.set_kp(self.kp)
    ...
    def set_fm(self, fm):
        self.fm = fm
        self.Signal_Source.set_frequency(self.fm)
    ...
    def set_Am(self, Am):
        self.Am = Am
        self.Signal_Source.set_amplitude(self.Am)
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.EnvolventeComplejaPMJ1C_0.set_Ac(self.Ac)
