...
# Title: Validar_Potencia
# Author: 2194667_Martinez_2195534_Perdomo_2184684_Ariza
# Copyright: UIS
...
class Validar_Potencia(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Validar_Potencia", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Validar_Potencia")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Validar_Potencia")
        ...
        # Blocks
        ##################################################
        self._Amplitud_range = Range(0, 50, 1, 1, 200)
...
def main(top_block_cls=Validar_Potencia, options=None):
